                                ...
                                <table class="table table-striped" id="table-2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>KKM</th>   <!-- Menambahkan kolom KKM -->
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($nilai as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->nilai }}</td> <!-- Menampilkan nilai -->
                                                <td>{{ $data->kkm }}</td>    <!-- Menampilkan KKM -->
                                                <td>
                                                    <div class="d-flex">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="nilai" id="nilai" class="form-control" placeholder="Masukkan Nilai" min="0" max="100" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="kkm">KKM</label>
                                                <input type="number" name="kkm" id="kkm" class="form-control" placeholder="Masukkan KKM" min="70" max="100">
                                            </div>
                                        </div>
                                    </div>
